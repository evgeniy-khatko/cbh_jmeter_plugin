...
public class GoogleBatchCreator extends AbstractJavaSamplerClient implements Serializable {
  ...
  private static Map<Integer, String> distribution = new TreeMap<Integer,String>();
  private static boolean badParams;
  private static Stack<String> correlations = new Stack<String>();
  ...
  private static long lastProcessingTime;
  ...
  public SampleResult runTest(JavaSamplerContext context) {
      ...
      try {
        ...
        if((System.currentTimeMillis() - start) > period*1000 && (System.currentTimeMillis() - getLastProcessingTime()) > THRESHOLD){
  ...
  private synchronized long getLastProcessingTime() {
    return lastProcessingTime;
  }

  private synchronized void setLastProcessingTime(long time){
